...
app = typer.Typer(
    help="CLI interface for ACH and air quality analysis for indoor areas"
)
...
def required_ach(
    ...
    mask_type: MaskType = typer.Option(
    ...
    inf_percent: List[float] = typer.Option(
